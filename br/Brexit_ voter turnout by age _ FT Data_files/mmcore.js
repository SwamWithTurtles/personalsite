...
if(!window.mmcore){
	window.mmcore={
		...
		cookie_domain:'.' + location.hostname.match(/[\w\-]*\.\w*(\.(uk|au|nz))?$/)[0],
		tpixel:false,
		cprefix:'mmcore.',
		inline_state:true,
	...
	//transport
		...
		_rt:1000,
	//private
		jsver:'5.17.1',_vars:{fv:{},act:{},uat:{},ids:{}},_act_id:0,_vars_alias:{act:'uv'},_renderers:{},_extensions:{},_r_mbs:{},
	...
	(function() {  // Extentions (plug-ins).
		...
		(function(e){var t="mm_vid",n=365,r=e._Clear,s=function(r){var s,i,o=[];for(s in r)r.hasOwnProperty(s)&&(i=r[s],o.push([escape(s),escape(i)].join("=")));e.SetCookie(t,o.join("&"),n,!0)};e._Clear=function(){r.apply(e,arguments);var t,n,s=e.GetPersistentVIDs();for(t in s)s.hasOwnProperty(t)&&(n=s[t],e.SetVisitorID(n,t))},e.SetPersistentVID=function(t,n){var r=e.GetPersistentVIDs(),n=n||1;r[n]=t,s(r),e.SetVisitorID(t,n)},e.UnsetPersistentVID=function(t){var n=e.GetPersistentVIDs(),t=t||1;n.hasOwnProperty(t)&&(delete n[t],s(n),e._vars.ids.hasOwnProperty(t)&&delete e._vars.ids[t])},e.GetPersistentVIDs=function(){var n={};return e.GetCookie(t,!0).replace(/([^&]*)=([^&]*)/g,function(e,t,r){n[unescape(t)]=unescape(r)}),n},e.GetPersistentVID=function(t){var n=e.GetPersistentVIDs(),t=t||1;return n.hasOwnProperty(t)?n[t]:null}})(mmcore);
		// _Host function.
...
// Diable requests from IE 10
if (!/MSIE 10/.test(navigator.userAgent)) mmcore.CGRequest(function(){mmcore.inline_state=false});
